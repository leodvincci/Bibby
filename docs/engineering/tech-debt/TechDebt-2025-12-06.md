...
**Interview angle:** "The refactoring wasn't complete until I removed the old dependencies, not just added the new
ones."
...
**Status:** Resolved for now—using `List<Long> books`  
