...
class BooklistTest {
    ...
    void renameBooklist_ShouldThrowException_WhenNewNameExceedsMaxLength() {
        ...
        // Assert
        assertThrows(IllegalArgumentException.class, () -> booklist.renameBooklist(new BooklistName(longName.toString())));
    }
    ...
    @Test
    void renameBooklist_ShouldUpdateUpdatedAtWithNewTimestamp_WhenCalledTwice() throws InterruptedException {
        // Arrange
    ...
    void renameBooklist_ShouldThrowException_WhenNewNameContainsOnlySpaces() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> booklist.renameBooklist(new BooklistName("   ")));
    }

    @Test
    void shouldThrowExceptionWhenValueIsNullOrBlank() {
        IllegalArgumentException exception1 = assertThrows(IllegalArgumentException.class, () -> new BooklistName(null));
        assertEquals("Booklist name cannot be null or blank", exception1.getMessage());

        IllegalArgumentException exception2 = assertThrows(IllegalArgumentException.class, () -> new BooklistName(""));
        assertEquals("Booklist name cannot be null or blank", exception2.getMessage());

        IllegalArgumentException exception3 = assertThrows(IllegalArgumentException.class, () -> new BooklistName("   "));
    ...
    void shouldThrowExceptionWhenValueIsTooLong() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> new BooklistName(longName));
        assertEquals("Booklist name cannot exceed 100 characters", exception.getMessage());
    }

    @ParameterizedTest
    @ValueSource(strings = {"Reading @ Home", "Books #1", "List & More", "Price: $10", "Name\nNewline"})
    ...
    void shouldThrowExceptionWhenValueContainsInvalidCharacters(String invalidValue) {
        ...
        void shouldHandleEmptyStringAfterWhitespaceReplacement() {
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new BooklistName("   "));
            assertEquals("Booklist name cannot be null or blank", exception.getMessage());
        }
}
