...
class BookcardRendererTest {
    ...
    void testCreateBookCard_NullPublisher() {
        ...
        // Assert
        assertNotNull(result);
        assertTrue(result.contains("Unknown"), "When publisher is null, 'Unknown' should be used as a fallback");
    }
    ...
    void testCreateBookCard_LongAuthorList() {
        ...
        String author = "John Doe, Jane Smith, Alice Johnson, Bob Brown, Charlie Davis, Eve White, George Martin, ..."
                + " and many others";
    ...
    void testCreateBookCard_LongTitle() {
        // Arrange
        BookcardRenderer renderer = new BookcardRenderer();
        String title = "An Extremely Long and Detailed Title that Will Likely Exceed Formatting Limits " +
