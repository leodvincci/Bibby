...
class BookManagementCommandsTest {
    ...
    /**
     * Test Description:
     * This test ensures that editing the publisher of a book successfully updates the publisher
     * and displays the updated book information.
     */
    @Test
    void testBookEditCommand_EditPublisherSuccess() {
        ...
        BookManagementCommands commands = new BookManagementCommands(cliPromptServiceMock, bookFacadeMock);

        // Mock the flow
        BookDTO initialBookDTO = new BookDTO(1L, 1, "Test Title", List.of("Author One"), "9781234567897",
                "Fiction", "Old Publisher", 2020, 1L,
                "Description", null, null, null, null);
        BookDTO updatedBookDTO = new BookDTO(1L, 1, "Test Title", List.of("Author One"), "9781234567897",
                "Fiction", "New Publisher", 2020, 1L,
                "Description", null, null, null, null);
        ...
        when(bookcardRendererMock.bookImportCard("Test Title", "9781234567897", "[Author One]", "New Publisher"))
    ...
    /**
     * Test Description:
     * This test ensures that when the user does not confirm the change to the publisher, no update is performed.
     */
    @Test
    void testBookEditCommand_EditPublisherCancelledByUser() {
        ...
        // Mock the flow
        BookDTO bookDTO = new BookDTO(1L, 1, "Test Title", List.of("Author One"), "9781234567897",
                "Fiction", "Old Publisher", 2020, 1L,
                "Description", null, null, null, null);
    ...
    /**
     * Test Description:
     * This test ensures that when the ISBN entered by the user does not correspond to an existing book,
    ...
    void testBookEditCommand_BookNotFound() {
        ...
        when(cliPromptServiceMock.promptForIsbn()).thenReturn("9781234567897");
        when(bookFacadeMock.findBookByIsbn("9781234567897")).thenThrow(new RuntimeException("Book not found"));
