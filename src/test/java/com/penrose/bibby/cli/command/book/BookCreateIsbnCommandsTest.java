...
class BookCreateIsbnCommandsTest {
    ...
    void createBookScan_whenUserSelectsNo_doesNotCreateBook() {
        ...
        BookCreateIsbnCommands commands = spy(new BookCreateIsbnCommands(
                cliPrompt,
                bookcardRenderer,
                bookFacade,
                bookcaseFacade,
        ...
        BookMetaDataResponse meta = new BookMetaDataResponse(
                1L,
                "Test Title",
                "9781234567897",
    ...
    void createBookScan_whenUserSelectsYes_andNoPlacement_createsBookWithNotSetLocation() {
        ...
        verify(bookcardRenderer, times(1)).createBookCard(
                "Test Title",
                "9781234567897",
