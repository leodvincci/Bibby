...
import { Big5Decoder, Big5Encoder } from '@zxing/text-encoding/esm/coders/big5';
import { EUCJPDecoder, EUCJPEncoder } from '@zxing/text-encoding/esm/coders/euc-jp';
import { EUCKRDecoder, EUCKREncoder } from '@zxing/text-encoding/esm/coders/euc-kr';
import { GB18030Decoder, GB18030Encoder } from '@zxing/text-encoding/esm/coders/gb18030';
import { ISO2022JPDecoder, ISO2022JPEncoder } from '@zxing/text-encoding/esm/coders/iso-2022-jp';
import { ShiftJISDecoder, ShiftJISEncoder } from '@zxing/text-encoding/esm/coders/shift-jis';
import { SingleByteDecoder, SingleByteEncoder } from '@zxing/text-encoding/esm/coders/single-byte';
import { UTF16Decoder, UTF16Encoder } from '@zxing/text-encoding/esm/coders/utf-16';
import { UTF8Decoder, UTF8Encoder } from '@zxing/text-encoding/esm/coders/utf-8';
import { XUserDefinedDecoder, XUserDefinedEncoder } from '@zxing/text-encoding/esm/coders/x-user-defined';
import { encodings } from '@zxing/text-encoding/esm/encoding/encodings';
import { index } from '@zxing/text-encoding/esm/encoding/indexes';
import { getEncodingIndexes } from '@zxing/text-encoding/esm/encoding/encoding-indexes-provider';
//
// Utilities
//
