...
import EncodeHintType from '@zxing/library/es2015/core/EncodeHintType';
import BitArray from '@zxing/library/es2015/core/common/BitArray';
import CharacterSetECI from '@zxing/library/es2015/core/common/CharacterSetECI';
import GenericGF from '@zxing/library/es2015/core/common/reedsolomon/GenericGF';
import ReedSolomonEncoder from '@zxing/library/es2015/core/common/reedsolomon/ReedSolomonEncoder';
import Mode from '@zxing/library/es2015/core/qrcode/decoder/Mode';
import Version from '@zxing/library/es2015/core/qrcode/decoder/Version';
import MaskUtil from '@zxing/library/es2015/core/qrcode/encoder/MaskUtil';
import ByteMatrix from '@zxing/library/es2015/core/qrcode/encoder/ByteMatrix';
import QRCode from '@zxing/library/es2015/core/qrcode/encoder/QRCode';
import MatrixUtil from '@zxing/library/es2015/core/qrcode/encoder/MatrixUtil';
import StringEncoding from '@zxing/library/es2015/core/util/StringEncoding';
import BlockPair from '@zxing/library/es2015/core/qrcode/encoder/BlockPair';
import WriterException from '@zxing/library/es2015/core/WriterException';
...
export default class Encoder {
    ...
    static encode(content, ecLevel, hints = null) {
        ...
        const hasEncodingHint = hints !== null && undefined !== hints.get(EncodeHintType.CHARACTER_SET);
        if (hasEncodingHint) {
