...
import EAN13Reader from '@zxing/library/es2015/core/oned/EAN13Reader';
import EAN8Reader from '@zxing/library/es2015/core/oned/EAN8Reader';
import UPCAReader from '@zxing/library/es2015/core/oned/UPCAReader';
import NotFoundException from '@zxing/library/es2015/core/NotFoundException';
import UPCEReader from '@zxing/library/es2015/core/oned/UPCEReader';
/**
        ...
        for (let reader of this.readers) {
            try {
                ...
                if (ean13MayBeUPCA && canReturnUPCA) {
                    ...
                    const resultUPCA = new Result(result.getText().substring(1), rawBytes, (rawBytes ? rawBytes.length : null), result.getResultPoints(), BarcodeFormat.UPC_A);
