...
public class AuthorService {
   ...
   *
   * <p>This operation takes a domain-level {@code Author} object containing updated information,
   * and persists those changes to the underlying persistence store.
   *
   * <p><strong>Contract:</strong>
   *
   * <ul>
   *   <li>The provided {@code Author} must already exist in the system.
   *   <li>If the Author does not exist, an exception may be thrown.
   *   <li>No value is returned; the operation is void.
   * </ul>
   *
   * @param author the domain {@code Author} object with updated details; must not be {@code null}
   *     and must represent an existing Author
   */
