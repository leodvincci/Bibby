...
public class BookMapper {
  ...
  public Book toDomain(BookDTO bookDTO, Set<AuthorDTO> authorDTOs, ShelfDTO shelfDTO) {
  ...
  public Book toDomain(BookEntity e, Set<AuthorRef> authorRefs, ShelfEntity shelfDTO) {
    ...
    book.setAvailabilityStatus(
        e.getAvailabilityStatus() != null
  ...
  //
  // authors.add(AuthorMapper.toDomain(authorEntity.getAuthorId(),authorEntity.getFirstName(),
  ...
  // AvailabilityStatus.valueOf(e.getAvailabilityStatus()) : null);
  //        book.setCreatedAt(e.getCreatedAt());
  //        book.setUpdatedAt(e.getUpdatedAt());
  //        return book;
  //    }
  ...
  public BookEntity toEntity(Book book) {
    ...
    bookEntity.setAvailabilityStatus(
        book.getAvailabilityStatus() != null ? book.getAvailabilityStatus().name() : null);
  ...
  public BookDTO toDTOfromEntity(BookEntity bookEntity) {
    ...
    return new BookDTO(
        ...
        bookEntity.getAvailabilityStatus() != null
            ? AvailabilityStatus.valueOf(bookEntity.getAvailabilityStatus())
            : null,
  ...
  public Set<AuthorEntity> toEntitySetFromAuthorRefs(List<AuthorRef> authors) {
    ...
    if (authors != null) {
      for (AuthorRef author : authors) {
        ...
        log.info(
            "Fetched AuthorEntity from AuthorFacade: "
        ...
        log.info(
            "Mapping AuthorRef to AuthorEntity: "
  ...
  public BookEntity toEntityFromBookMetaDataResponse(
    ...
    //        log.info("Authors " + String.join(", ", authorDTOS.toString()) + " ensured to exist in
    // the system.");
    BookEntity bookEntity = new BookEntity();
    bookEntity.setTitle(bookMetaDataResponse.title());
    bookEntity.setIsbn(isbn);
    //        log.info("Fetching AuthorEntities for authors: " + String.join(", ",
    // authorDTOS.toString()));
    ...
    bookEntity.setDescription(
        bookMetaDataResponse.description().orElse("No description available."));
      ...
      BriefBibliographicRecord briefBibliographicRecord =
          new BriefBibliographicRecord(
              ...
              book.getAuthors().stream()
                  .map(AuthorRef::getAuthorName)
                  .map(AuthorName::getFullName)
                  .toList(),
              book.getEdition(),
              book.getPublisher(),
