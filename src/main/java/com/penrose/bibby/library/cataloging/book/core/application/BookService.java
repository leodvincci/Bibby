...
public class BookService {
  ...
  //    public BookDTO createBookFromScan(GoogleBooksResponse googleBooksResponse, String isbn, Long
  // shelfId){
  ...
  //        if (googleBooksResponse == null || googleBooksResponse.items() == null ||
  ...
  //    @Override
  //    public void createBookFromMetaData(BookMetaDataResponse bookMetaDataResponse, String isbn,
  // Long shelfId) {
  //
