...
public class AuthorMapper {
  ...
  public static Set<AuthorDTO> toDTOSet(Set<Author> authors) {
    ...
    for (Author author : authors) {
      AuthorDTO authorDTO =
          new AuthorDTO(author.getAuthorId().id(), author.getFirstName(), author.getLastName());
  ...
  public static AuthorDTO toDTO(Author author) {
    return new AuthorDTO(author.getAuthorId().id(), author.getFirstName(), author.getLastName());
  }
